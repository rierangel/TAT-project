...
export default function Page(props) {
  ...
  useEffect(() => {
     ...
     //data
     fetcher(`${process.env.NEXT_PUBLIC_URL_BACKEND}/entradas/cultura-tributaria/`)
  ...
  const path = "entradas/cultura-tributaria"

  const query= `${process.env.NEXT_PUBLIC_URL_BACKEND}/entradas/cultura-tributaria/`
  const NoticiasListQuery = QueryLayer(NoticiaList, datalist, buscador, query, path, null, "cultura-tributaria")

  const page = {
    "id": 32,
    "contenido": [],
    "titulo": "Cultura Tributaria",
