...
import LastResolutions from 'src/components/home/LastResolutions'
import Paginas from 'src/components/home/Paginas'
      ...
      <div className='flex flex-col-reverse md:flex-row '>
        <div className='w-full h-auto md:my-auto -mt-[10%]'>
          ...
          <div className='flex flex-col md:flex-row gap-3 md:gap-6'>
            ...
            >
              <a className='btn w-full md:w-auto outline flex-center'>
                <div className='svg_rp h-auto md:w-[27px] w-[15px]'>
                  <svg width="28" height="34" viewBox="0 0 28 34" fill="none" xmlns="http://www.w3.org/2000/svg">
