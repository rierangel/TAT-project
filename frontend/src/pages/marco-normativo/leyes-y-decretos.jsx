...
export default function Page() {
  ...
  useEffect(() => {
    // page
    fetcher(`${process.env.NEXT_PUBLIC_URL_BACKEND}/paginas/7`)
      .then(res => setPage(res))
      .catch(error => console.log(error))

    // data
    fetcher(`${process.env.NEXT_PUBLIC_URL_BACKEND}/marco-normativo/leyes-y-decretos/`)
  ...
  const path = `marco-normativo/leyes-y-decretos`
