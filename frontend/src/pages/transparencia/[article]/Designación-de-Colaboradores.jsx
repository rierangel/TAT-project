...
export default function Component() {
  ...
  useEffect(() => {
    ...
    // data
    fetcher(`${process.env.NEXT_PUBLIC_URL_BACKEND}/transparencia/A112_DesignaciónDeColaboradoresViewSet/`)
  ...
  const path = `transparencia/A112_DesignaciónDeColaboradoresViewSet`
