...
export default function Component() {
  ...
  useEffect(() => {
    ...
    // data
    fetcher(`${process.env.NEXT_PUBLIC_URL_BACKEND}/transparencia/A102_EjecucionesPresupuestariasViewSet/`)
  ...
  const path = `transparencia/A102_EjecucionesPresupuestariasViewSet`
