...
export default function Component() {
  ...
  useEffect(() => {
    ...
    fetcher(`${process.env.NEXT_PUBLIC_URL_BACKEND}/transparencia/A263_ParticipaciónCiudadanaViewSet/`)
  ...
  const path = `transparencia/A263_ParticipaciónCiudadanaViewSet`
