...
export default function Component() {
  ...
  useEffect(() => {
    ...
    // data
    fetcher(`${process.env.NEXT_PUBLIC_URL_BACKEND}/transparencia/A097_DescripciónDeFormulariosViewSet/`)
  ...
  const path = `transparencia/A097_DescripciónDeFormulariosViewSet`
