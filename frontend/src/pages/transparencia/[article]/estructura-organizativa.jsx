...
export default function Component() {
  ...
  useEffect(() => {
    ...
    // data
    fetcher(`${process.env.NEXT_PUBLIC_URL_BACKEND}/transparencia/A095_EstructuraOrganizativaViewSet/`)
  ...
  const path = `transparencia/A095_EstructuraOrganizativaViewSet`
