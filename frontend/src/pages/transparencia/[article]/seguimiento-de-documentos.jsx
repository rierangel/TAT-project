...
export default function Component() {
  ...
  useEffect(() => {
    ...
    // data
    fetcher(`${process.env.NEXT_PUBLIC_URL_BACKEND}/transparencia/A096_SeguimientoDeDocumentosViewSet/`)
  ...
  const path = `transparencia/A096_SeguimientoDeDocumentosViewSet`
