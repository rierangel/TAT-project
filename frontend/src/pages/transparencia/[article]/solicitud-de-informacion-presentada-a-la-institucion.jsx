...
export default function Component() {
  ...
  const title = {
    ...
    titulo: "Solicitud de Información Presentada a la Institución"
  }
  const [data, setData] = useState()
  useEffect(() => {
    // data
    fetcher(`${process.env.NEXT_PUBLIC_URL_BACKEND}/transparencia/A261_SolicitudDeInformaciónPresentadaALaInstituciónViewSet/`)
  ...
  const path = `transparencia/A261_SolicitudDeInformaciónPresentadaALaInstituciónViewSet`
