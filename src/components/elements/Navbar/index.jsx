        ...
        <nav className={styles.navbar}>
            ...
            <div className="container ">
                <div className={styles.top}>
                    ...
                    <img className=" w-32 h-10 md:w-auto md:h-auto object-cover scale-150 md:scale-100" src="/img/logo.png" alt="" />
                    ...
                    <div className='md:hidden cursor-pointer py-6 px-4 -mr-4' onClick={() => setShowSearch(true)}>
                ...
                <div className='hidden md:flex'>
                    ...
                    <div
                        ...
                        className='flex items-center cursor-pointer pb-6'>
