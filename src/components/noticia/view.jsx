...
export default function view() {
  ...
  return (
    <>
      ...
      <p className='mt-12 mb-16'>El Tribunal Administrativo Tributario, atendiendo invitación del Centro Regional Universitario de Veraguas (CRUV), participó en la jornada académica organizada por la Escuela de Contabilidad del citado centro de enseñanza superior en el marco de la celebración del Día del Contador.
        ...
        Las autoridades del Centro Regional Universitario de Veraguas manifestaron su gratitud y complacencia por el intercambio académico realizado por el TAT durante esta significativa fecha, al tiempo que expresaron su interés por continuar organizando actividades de esta naturaleza.</p>
      <hr />
