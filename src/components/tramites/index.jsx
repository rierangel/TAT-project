        ...
        <>
            ...
            <section className=''>
                <div className='
                    ...
                    <div className='absolute top-[105px] right-[480px] hidden lg:flex'>
                        <SvgDots width={"100%"} height={"100%"} fill="#ffffff1a" />
                    </div>

                    <div className='absolute bottom-0 top-0  right-[280px] hidden lg:flex'>
            ...
            <section id='t-apelacion' >
                ...
                <div className="border1 p-9 rounded-xl" >
                    <div className="dot_interes">
                        ...
                        <p>La presentación de la Apelación a través de esta vía requiere que se aporten los documentos físicos, en las oficinas del Tribunal, en las siguientes 48 horas para que la solicitud sea considerada válida.</p>
                    </div>
                    ...
                    <form action="" className="form">
                        ...
                        <div className='mt-9'>
                            ...
                            <div className="single">
                                <span className='text-base leading-6 font-bold'>Solicitud de apelación</span>
